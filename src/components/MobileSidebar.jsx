...
export default function MobileSidebar({ open, onClose, ...contentProps }) {
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed left-0 top-0 z-50 h-full w-72 md:hidden flex flex-col transition-transform duration-300 ${
      ...
      >
        <div className="h-full flex flex-col bg-[#0c1428] border-r border-slate-700/40 shadow-2xl overflow-hidden">
